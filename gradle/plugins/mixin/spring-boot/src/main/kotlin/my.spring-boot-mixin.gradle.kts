...
plugins {
  ...
  // in fact, even the dependency-management plugin is optional, since we can just use
  // the platform("org.springframework.boot:spring-boot-dependencies") directly.
